...
@RestController("SubscriptionControllerMaturityLevel1")
@AllArgsConstructor
@RequestMapping("/v1")
public class SubscriptionController {
    ...
    @PostMapping("/getSubscription/{id}")
    ...
    @PostMapping("/getAllSubscriptionForUser/{id}")
    ...
    @PostMapping("/deleteSubscription/{id}")
